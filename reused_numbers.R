...
calc_reused_num <- function(vols, ylim, vols_name, group_name, decadeStart = NULL, decadeEnd = NULL) {
 ...
 allNumbersList <- list()
  ...
  for(i in 1:8) {
    ...
    #file <- paste("C:/Users/mikko/OneDrive/Desktop/Gradu/cleaned_thesis_code/graphs/unused/fig_reused_numbers_", group_name, "_", vols_name, "_", i,".png", sep="")
  ...
  #file <- paste("C:/Users/mikko/OneDrive/Ty?p?yt?/Gradu/cleaned_thesis_code/graphs/unused/fig_reused_numbers_", group_name, "_", vols_name, "_", group_name, ".png", sep="")
  #png(file=file,width=1200, height=700)
  #print(hits_figs)
  #dev.off()
